...
const AboutHero: React.FC = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-luxury-black luxury-gradient-overlay pt-20">
      <div className="absolute inset-0 bg-[url('https://static.vecteezy.com/system/resources/previews/031/858/279/large_2x/wedding-in-kerala-kerala-weddinggraphy-ai-generated-free-photo.jpg')] bg-cover bg-center opacity-20"></div>
