...
interface BulkImportImageDialogProps {
  show: boolean;
  onClose: () => void;
  productTitle: string;
  imageData: Record<string, ColorImageData>;
  onSave: (imageData: Record<string, ColorImageData>) => void;
  onRealTimeUpdate?: (imageData: Record<string, ColorImageData>) => void;
}

const BulkImportImageDialog: React.FC<BulkImportImageDialogProps> = ({
  show,
  onClose,
  productTitle,
  imageData,
