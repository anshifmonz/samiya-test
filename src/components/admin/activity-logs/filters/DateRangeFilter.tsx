...
export const DateRangeFilter: React.FC<DateRangeFilterProps> = ({
  ...
  const hasChanges = selectedRange.from?.getTime() !== value.from?.getTime() ||
          ...
          <div className="bg-admin-card/95 backdrop-blur-sm border border-admin-muted/50 rounded-lg p-2">
            <CalendarComponent
              ...
              classNames={{
                ...
                head_cell: "text-admin-muted-foreground rounded-md !w-9 !h-9 !min-w-9 !max-w-9 flex items-center justify-center font-medium text-xs uppercase tracking-wide flex-shrink-0 basis-9",
                ...
                day_range_end: "day-range-end bg-primary text-primary-foreground hover:bg-primary/90 font-semibold shadow-sm",
                day_selected: cn(
                ...
                day_today: "bg-admin-muted/50 text-admin-foreground font-bold border-2 border-primary/50 shadow-sm",
                day_outside: "day-outside text-admin-muted-foreground opacity-40 aria-selected:bg-primary/10 aria-selected:text-admin-muted-foreground aria-selected:opacity-50",
