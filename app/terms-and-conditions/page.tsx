            ...
            <div className="luxury-body text-luxury-black leading-relaxed space-y-6">
              ...
              <ul className="space-y-6 list-none">
                <li className="flex items-start space-x-4">
                  ...
                  <p>
                    <strong>Account Information:</strong> To access and use the Services, you agree to provide true, accurate and complete information to us
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Disclaimer of Warranties:</strong> Neither we nor any third parties provide any warranty or guarantee as to the accuracy, timeliness,
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Use at Own Risk:</strong> Your use of our Services and the website is solely at your own risk and discretion. You are
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Intellectual Property:</strong> The contents of the Website and the Services are proprietary to Us and you will not have any
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Unauthorized Use:</strong> You acknowledge that unauthorized use of the Website or the Services may lead to action against
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Payment Obligations:</strong> You agree to pay us the charges associated with availing the Services.
                  </p>
                </li>
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Lawful Use:</strong> You agree not to use the website and/or Services for any purpose that is unlawful, illegal or
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Third Party Links:</strong> You agree and acknowledge that website and the Services may contain links to other third party
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Binding Contract:</strong> You understand that upon initiating a transaction for availing the Services you are entering into a
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Refund Policy:</strong> You shall be entitled to claim a refund of the payment made by you in case we are not able to
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Force Majeure:</strong> Notwithstanding anything contained in these Terms, the parties shall not be liable for any failure to
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Governing Law:</strong> These Terms and any dispute or claim relating to it, or its enforceability, shall be governed by and
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Jurisdiction:</strong> All disputes arising out of or in connection with these Terms shall be subject to the exclusive
                    jurisdiction of the courts in <strong>MANNARKAD-I, KERALA</strong>.
                  </p>
                </li>
                ...
                <li className="flex items-start space-x-4">
                  <span className="flex-shrink-0 w-2 h-2 bg-luxury-gold rounded-full mt-3" aria-hidden="true"></span>
                  <p>
                    <strong>Contact Information:</strong> All concerns or communications relating to these Terms must be communicated to us using the
