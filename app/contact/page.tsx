  ...
  return (
    <main className="min-h-screen bg-luxury-white pt-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16" aria-label="Contact Information">
          <article className="bg-white rounded-xl border border-luxury-gray/10 p-8 shadow-sm">
            <header className="flex items-center mb-6">
              <div className="w-12 h-12 bg-luxury-gold/10 rounded-lg flex items-center justify-center mr-4" aria-hidden="true">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="luxury-body text-sm text-luxury-gray uppercase tracking-wider mb-1">Legal Entity</h3>
          ...
          <article className="bg-white rounded-xl border border-luxury-gray/10 p-8 shadow-sm">
            ...
            <address className="space-y-6 not-italic">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="luxury-body text-sm text-luxury-gray uppercase tracking-wider">Phone</h3>
                  <a href="tel:+919562700999" className="luxury-body text-luxury-black hover:text-luxury-gold transition-colors">
                    +91 9562700999
                  </a>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="luxury-body text-sm text-luxury-gray uppercase tracking-wider">Email</h3>
                  <a href="mailto:samiyaorders0@gmail.com" className="luxury-body text-luxury-black hover:text-luxury-gold transition-colors">
        ...
        <section className="bg-white rounded-xl border border-luxury-gray/10 p-8 shadow-sm" aria-label="Business Address">
          <header className="flex items-center mb-6">
            <div className="w-12 h-12 bg-luxury-gold/10 rounded-lg flex items-center justify-center mr-4" aria-hidden="true">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <address className="not-italic">
              <h3 className="luxury-body text-sm text-luxury-gray uppercase tracking-wider mb-2">Registered Address</h3>
            ...
            <address className="not-italic">
              <h3 className="luxury-body text-sm text-luxury-gray uppercase tracking-wider mb-2">Operational Address</h3>
              <div className="luxury-body text-luxury-black leading-relaxed">
                <p>MP-IX/348 B, PAZHERI PLAZA</p>
                <p>KODATHIPPADI, MANNARKKAD</p>
                <p>MANNARKAD-I, KERALA</p>
